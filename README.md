...
<GhBadge
  url={'https://crates.io/crates/rudderanalytics/'}
  repo={'crates/v/rudderanalytics'}
  style={'flat'}
/>
...
- Once signed up, <Link to="/dashboard-guides/sources/#adding-a-source">set up a Rust source</Link> in the dashboard. You should be able to see a **Write Key** for this source, as shown below:

<img src="../../../assets/event-stream-sources/rust-write-key-new.png" alt="Rust source write key" />
...
The <strong>Setup</strong> tab in the RudderStack dashboard (seen above) has an SDK installation snippet containing both the write key and the data plane URL. You can use it to integrate the Rust SDK into your application.
</div>
...
For more information on each of calls, refer to the [**RudderStack Events Specification**](https://rudderstack.com/docs/event-spec/standard-events/) guide.
...
<div class="successBlock">
  ...
  <ul>
    ...
    <li>
      ...
      supported by the
      <a href="https://rudderstack.com/docs/sources/event-streams/sdks/rudderstack-javascript-sdk/">
        JavaScript SDK
      </a>
       via <a href="https://rudderstack.com/docs/destinations/rudderstack-connection-modes/#cloud-mode">
        cloud mode
      </a>)
    </li>
    <li>
